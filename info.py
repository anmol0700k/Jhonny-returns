...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b><i>{file_name} � {file_size} � [??? ???????? ?????? | ??????? ?? Q??????](https://t.me/Pros_Movies_Empire)</i></b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "<b><i>{file_name} � {file_size} � [??? ???????? ?????? | ??????? ?? Q??????](https://t.me/Pros_Movies_Empire)</i></b>")
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "?? ??????????: <a href={url}>{title}</a> \n?? ????????: {year} \n?? ??????????????: {rating}/ 10 \n?? ????????????: {genres} \n\n?? ?????????????? ???? [??? ???????? ??????](https://t.me/Pros_Movies_Empire)")
